  ...
  <nav>
    ...
    <ul>
      ...
      <li>
        ...
        <ul>
          <li><a class="active"  href="payment">Payment</a></li>
        ...
        <ul class="nav-links">
          ...
          <div class="menu">
            ...
            <li class="transaction">
              <a class="active" href="" style="text-decoration: none">Transaction</a>
    
              <!-- DROPDOWN MENU -->
              <ul class="dropdown">
                <li><a class="active" href="payment" style="text-decoration: none">Payment</a></li>
