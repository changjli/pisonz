  ...
  <form action="/payment" method="post">
    ...
    <section class="p-3 mx-auto mt-5 md:w-3/4 md:mt-20">
      ...
      <div class="relative w-full p-5 py-8 mt-5 bg-teal-100 rounded-3xl">
        ...
        <div class="gap-2 p-5 mt-2 rounded-t-lg bg-primary md:flex md:items-center justify-evenly flex-wrap">
          <main>
            ...
            <input type="text" id="default-search"
              ...
              placeholder="ex: 2541554124 (12345)" name="user_id" autocomplete="off" value="{{ old('user_id') }}" />
            @error('user_id')
          ...
          <main>
            <h2 class="mt-3 mb-2 text-white md:text-center md:mt-0 font-['Poppins'] tracking-[1px]">User
              Nickname</h2>
          ...
          <p class="mt-2 italic text-slate-200 text-sm md:text-base">
            Klik profile maka akan terlihat <strong>User ID</strong> dibagian bawah <strong>Username</strong> Anda.
            Silakan
            masukkan <strong>User ID</strong> dan <strong>Username</strong> untuk menyelesaikan transaksi.
          </p>
        </div>
      </div>
      ...
      <div class="relative w-full p-5 py-8 mt-5 bg-teal-100 rounded-3xl">
        ...
        <div class="mt-3">
          @foreach ($game->Category as $category)
            <div class="text-primary font-bold mt-3 font-['Poppins'] tracking-[1px] text-sm">
              {{ $category->name }}</div>
      ...
      <div class="relative w-full p-5 py-8 mt-5 bg-teal-100 rounded-3xl">
        ...
        <div class="p-6 mx-auto border border-gray-200 shadow bg-primary rounded-2xl md:max-w-3xl">
          ...
          <div class="relative">
            <input type="text" id="default-search"
              class="block w-full p-4 font-medium rounded-lg md:text-lg text-dark bg-gray-50 focus:ring-blue-500 focus:border-blue-50 font-['Poppins'] @error('promo') border-4 border-red-600  @enderror tracking-[1px]"
              placeholder="ex: pz-101" name="promo" value="{{ old('promo') }}" />
            @error('promo')
              <div class="text-red-600 font-bold font-['Poppins']">
                {{ $message }}
              </div>
      ...
      <div class="relative w-full p-5 py-8 mt-5 bg-teal-100 rounded-3xl">
        ...
        <div class="max-w-sm p-6 mx-auto mt-10 border border-gray-200 shadow bg-primary rounded-2xl md:max-w-3xl">
          ...
          <div class="relative">
            <input type="text" id="default-search"
              class="block w-full p-4 font-medium  rounded-lg md:text-lg text-dark bg-gray-50 focus:ring-blue-500 focus:border-blue-50 font-['Poppins'] @error('phone') border-4 border-red-600  @enderror tracking-[1px]"
              placeholder="ex: 081212541247" name="phone" value="{{ old('phone') }}" />
            @error('phone')
              <div class="text-red-600 font-bold font-['Poppins']">
                {{ $message }}
              </div>
