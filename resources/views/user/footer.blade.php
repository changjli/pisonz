<footer class="bg-primary mt-60 flex justify-center flex-col items-center text-white font-['Poppins']">
  <img src="/assets/logo.png" class="w-16 h-10 my-3" alt="" />
  <h1 class="text-2xl font-semibold">Always Be For You</h1>
  <h2>Payments</h2>
  ...
  <div class="flex justify-center items-center my-3 gap-5">
    <div>
      <a href="https://www.instagram.com/pisonz.store/" target="_blank">
        <img src="/assets/footer/contact/ig.png" class="mx-auto" alt="" />
      </a>
      <p class="text-[.8rem]">pisonz.store</p>
    </div>
    <div>
      <a href="https://wa.me/6281363512273" target="_blank">
