...
<div class="container">
  <div class="row">
    ...
    <div class="column-33" id="viewtransaction">
        <img src="<?php echo e(asset('assets/transexample.png')); ?>" width="335" height="471">
    </div>
  </div>
</div>
<!--category section-->
<div class="container" style="background-color:#f1f1f1">
  <div class="row">
    <div class="column-33"  id="viewcategory">
      <img src="<?php echo e(asset('assets/categoryexample.jpeg')); ?>" alt="App" width="335" height="471">
    </div>
    <div class="column-66">
...
<div class="container">
  <div class="row">
    ...
    <div class="column-33" id="viewproduct">
        <img src="<?php echo e(asset('assets/download.png')); ?>" width="335" height="471" >
    </div>
  </div>
</div>
<!--game section-->
...
</html><?php /**PATH C:\Users\Jonas\Documents\Semester 5\Pisonz Store\pisonz\resources\views/home.blade.php ENDPATH**/ ?>